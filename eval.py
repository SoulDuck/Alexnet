...
def eval(model_path ,test_images):
    ...
    sess = tf.Session()
    saver = tf.train.import_meta_graph(meta_graph_or_file='./models/fundus_300/.meta') #example model path ./models/fundus_300/5/model_1.ckpt
...
if __name__ =='__main__':
    model_path ='./model/fundus_300/0'
    eval('/models/fundus_300/model_9000.ckpt', test_images)
